...
/**
 * Queued notification with partial viaConnections map
 */
class TestQueuedNotificationWithViaConnections extends Notification implements ShouldQueueInterface
{
    /**
     * Constructor
     */
